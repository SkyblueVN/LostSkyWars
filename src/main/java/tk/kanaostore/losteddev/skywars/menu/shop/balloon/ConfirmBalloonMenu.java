package tk.kanaostore.losteddev.skywars.menu.shop.balloon;
...
public class ConfirmBalloonMenu extends PlayerMenu {
  ...
  public ConfirmBalloonMenu(Player player, Cosmetic cosmetic, Class<?> returns) {
