...
public class InsaneSkyWarsKit extends SkyWarsKit {

  private ItemStack[] armor;
  private ItemStack[] content;
  
  public InsaneSkyWarsKit(int id, String name, CosmeticRarity rarity, String permission, ItemStack icon, int coins, ItemStack[] armor, ItemStack[] content) {
  ...
  public static void setupKits() {
    ...
    for (String key : cu.getKeys(false)) {
      ...
      CosmeticServer.SKYWARS.addCosmetic(new InsaneSkyWarsKit(id, name, rarity, permission, icon, price, armor, content));
    }
  }
