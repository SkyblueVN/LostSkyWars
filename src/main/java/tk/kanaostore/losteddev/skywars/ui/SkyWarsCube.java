...
public class SkyWarsCube implements Iterable<Block> {

  private String world;
  private int xmax, xmin, ymax, ymin, zmax, zmin;

  public SkyWarsCube(Location l1, Location l2) {
  ...
  public SkyWarsCube(String serializedCube) {
  ...
  public class CubeIterator implements Iterator<Block> {
    ...
    public CubeIterator(SkyWarsCube cuboId) {
      x = y = z = 0;
      baseX = getXmin();
      baseY = getYmin();
      baseZ = getZmin();
