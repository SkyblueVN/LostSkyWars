package tk.kanaostore.losteddev.skywars.nms.v1_11_R1;
...
import tk.kanaostore.losteddev.skywars.nms.v1_11_R1.entity.BalloonEntityBat;
import tk.kanaostore.losteddev.skywars.nms.v1_11_R1.entity.BalloonEntityGiant;
import tk.kanaostore.losteddev.skywars.nms.v1_11_R1.entity.BalloonEntityLeash;
import tk.kanaostore.losteddev.skywars.nms.v1_11_R1.entity.EntityArmorStand;
import tk.kanaostore.losteddev.skywars.nms.v1_11_R1.entity.EntityArmorStand.CraftArmorStand;
import tk.kanaostore.losteddev.skywars.nms.v1_11_R1.entity.EntityStand;
import tk.kanaostore.losteddev.skywars.utils.LostLogger.LostLevel;

public class NMS1_11R1 extends NMSBridge {
  ...
  private void registerEntity(int entityId, String entityName, Class<? extends net.minecraft.server.v1_11_R1.Entity> entityClass) {
  ...
  public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
    ...
    net.minecraft.server.v1_11_R1.Entity entity = (net.minecraft.server.v1_11_R1.Entity) armor;
  ...
  public Hologram getHologram(Entity entity) {
    ...
    net.minecraft.server.v1_11_R1.Entity en = ((CraftEntity) entity).getHandle();
  ...
  private boolean addEntity(net.minecraft.server.v1_11_R1.Entity entity) {
    try {
