package tk.kanaostore.losteddev.skywars.nms.v1_9_R1.entity;
...
public class EntityArmorStand extends net.minecraft.server.v1_9_R1.EntityArmorStand
  ...
  public EntityArmorStand(World world, HologramLine line) {
    ...
    this.line = line;
    try {
      Field field = net.minecraft.server.v1_9_R1.EntityArmorStand.class.getDeclaredField("bz");
  ...
  public static class CraftArmorStand
      extends org.bukkit.craftbukkit.v1_9_R1.entity.CraftArmorStand implements IArmorStand {
