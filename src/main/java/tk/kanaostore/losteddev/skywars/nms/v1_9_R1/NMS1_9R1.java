package tk.kanaostore.losteddev.skywars.nms.v1_9_R1;
...
import tk.kanaostore.losteddev.skywars.nms.v1_9_R1.entity.BalloonEntityBat;
import tk.kanaostore.losteddev.skywars.nms.v1_9_R1.entity.BalloonEntityGiant;
import tk.kanaostore.losteddev.skywars.nms.v1_9_R1.entity.BalloonEntityLeash;
import tk.kanaostore.losteddev.skywars.nms.v1_9_R1.entity.EntityArmorStand;
import tk.kanaostore.losteddev.skywars.nms.v1_9_R1.entity.EntityArmorStand.CraftArmorStand;
import tk.kanaostore.losteddev.skywars.nms.v1_9_R1.entity.EntityStand;
import tk.kanaostore.losteddev.skywars.utils.LostLogger.LostLevel;

public class NMS1_9R1 extends NMSBridge {
  ...
  public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
    ...
    net.minecraft.server.v1_9_R1.Entity entity = (net.minecraft.server.v1_9_R1.Entity) armor;
  ...
  private boolean addEntity(net.minecraft.server.v1_9_R1.Entity entity) {
    try {
