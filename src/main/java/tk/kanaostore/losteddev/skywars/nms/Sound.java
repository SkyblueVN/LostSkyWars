...
public enum Sound {
  ...
  Sound(String oldSound, String newSound) {
  ...
  public void play(Player player, Location location, float f1, float f2) {
    player.playSound(location, getSound(), f1, f2);
  }

  public void play(Location location, float f1, float f2) {
    this.play(location.getWorld(), location, f1, f2);
  }

  public void play(World world, Location location, float f1, float f2) {
    world.playSound(location, getSound(), f1, f2);
  }

  public org.bukkit.Sound getSound() {
    org.bukkit.Sound localSound;
    try {
      localSound = org.bukkit.Sound.valueOf(oldSound);
    } catch (Exception e) {
      localSound = org.bukkit.Sound.valueOf(newSound);
    }
